...
prepare_fuzz:
	...
	mkdir automated_testing/results
	mkdir automated_testing/modified_files
	mkdir automated_testing/test_files
	mkdir automated_testing/err_keys
	mkdir automated_testing/output_files
